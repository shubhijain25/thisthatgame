A simple and interactive "This or That" quiz game that lets users select between two options for each question. The game dynamically updates the score and displays the result at the end.
